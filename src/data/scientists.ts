...
export const scientists: Scientist[] = [
  ...
  },
  {
    ...
    years: '1901 - 1976',
    contribution: '矩阵力学创始人 · 不确定性原理 · 特殊关卡',
    accentColor: 'green',
    isSpecial: true,
    concept: {
      title: '不确定性原理',
      ...
      description: '1927年，海森堡提出了著名的不确定性原理：我们不可能同时精确知道一个粒子的位置和动量。位置测量得越精确，动量就越不确定；反之亦然。这不是测量技术的限制，而是量子系统的内禀属性。',
      history: '海森堡最初用"伽马射线显微镜"思想实验来说明不确定性原理：想用短波光子精确测位置，光子的高能量就会干扰电子的动量；想用长波光子减少干扰，位置精度又不够。但玻尔指出，这只是"观察者效应"，不确定性原理的本质更深——它源于波粒二象性，是位置和动量这两个可观测量根本的不相容性。这一原理从根本上改变了我们对"物理实在"的理解。',
    },
    puzzle: {
      type: 'heisenberg-quiz',
      title: '不确定性原理 · 量子极限挑战',
      instruction: '回答关于海森堡不确定性原理的5道问题。每道题都会影响你对位置和动量的测量精度——记住，你不可能同时精确知道两者！正确率60%以上解锁成就。',
      targets: [],
      options: [],
    },
    recording: {
      ...
      speaker: '维尔纳·海森堡',
      year: '1970年代 访谈',
      text: '当我第一次意识到我们不能同时知道位置和动量的时候，我感到一阵眩晕。这意味着什么？难道我们对自然的认识有一个根本的极限吗？我和玻尔为此争论了好几个月，常常直到深夜。玻尔说，问题不在于我们的测量仪器，而在于我们对"实在"这个词的理解。在量子世界里，谈论一个粒子"本来"具有怎样的位置和动量是没有意义的。我们只能谈论测量结果的概率分布。我相信，这就是自然告诉我们的：确定性的终结，不是科学的失败，而是科学的成熟。我们终于意识到，人类不是宇宙之外的旁观者，而是参与其中的演员。',
    },
  },
];
